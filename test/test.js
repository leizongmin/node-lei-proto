...
describe("normal", function() {
  ...
  it("#5 - float & double LE", function() {
    const p = parseProto([["a", "float", 0, "LE"], ["b", "double", 0, "LE"]]);
  ...
  it("#6 - float & double BE", function() {
    const p = parseProto([["a", "float", 0, "BE"], ["b", "double", 0, "BE"]]);
    const b = p.encodeStrict(12.345, 67.891011);
    const c = p.decodeStrict(b);
    dump(b);
    dump(c);
  ...
  it("#7 - string & buffer", function() {
    const p = parseProto([["a", "string", 10], ["b", "buffer", 10]]);
  ...
  it("#9 - variable length - string", function() {
    const p = parseProto([["a", "string", 6], ["b", "string"]]);
  ...
  it("#10 - variable length - buffer", function() {
    const p = parseProto([["a", "buffer", 10], ["b", "buffer"]]);
...
describe("not need `size`", function() {
  it("#1 float & double", function() {
    const p = parseProto([["a", "float"], ["b", "double"]]);
    const b = p.encodeStrict(12.345, 67.891011);
    const c = p.decodeStrict(b);
    dump(b);
    dump(c);
  ...
  it("#2 last `string` item", function() {
    const p = parseProto([["a", "string", 5], ["b", "string"]]);
  ...
  it("#3 last `buffer` item", function() {
    const p = parseProto([["a", "buffer", 5], ["b", "buffer"]]);
